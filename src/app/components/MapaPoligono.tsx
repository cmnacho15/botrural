...
<button
  ...
  className="hidden sm:flex absolute top-3 left-3 z-[400] bg-white rounded-lg shadow-lg hover:shadow-xl transition-all w-[34px] h-[34px] sm:w-[36px] sm:h-[36px] items-center justify-center border-2 border-gray-300"
...
>
      ...
      <button
        ...
        className="absolute top-[70px] right-3 z-[400] bg-white rounded-lg shadow-lg hover:shadow-xl transition-all w-[34px] h-[34px] sm:w-[36px] sm:h-[36px] flex items-center justify-center disabled:opacity-50 border-2 border-gray-300"
        title="Mi ubicación"
      >
        {ubicandoUsuario ? (
      ...
      {!readOnly && (
        <div className="absolute top-4 left-4 right-4 z-[400] md:left-16 md:w-96">
      ...
      {!readOnly && areaHectareas !== null && (
        <div className="absolute top-4 right-4 z-[400] bg-green-600 text-white px-4 py-2 rounded-lg shadow-lg">
