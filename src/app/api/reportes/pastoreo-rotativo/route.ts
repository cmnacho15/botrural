      ...
      for (const ciclo of ciclos) {
        ...
        if (ciclo.salidas && ciclo.salidas.length > 0) {
          ciclo.salidas.forEach((salida: any) => {
            ...
            comentariosPartesHtml.push(`<span style="background-color: #FCA5A5; padding: 2px 6px; border-radius: 4px; font-weight: 500;">-${salida.cantidad} ${salida.categoria || 'Animales'} (${fechaCorta})</span>`)
