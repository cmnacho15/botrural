        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden mt-6">
          ...
          <div className="border-b border-gray-200">
            <button
              ...
              className="w-full px-6 py-4 flex items-center justify-between hover:bg-blue-50 transition-all group"
            >
              <div className="flex items-center gap-3">
                <span className="text-2xl">🐄</span>
                <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition">VACUNOS</h3>
                <span className="text-sm text-gray-500">({ventasVacunos.length} ventas)</span>
              </div>
              <svg
                className={`w-5 h-5 text-gray-500 transition-transform duration-200 ${vacunosAbierto ? 'rotate-90' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
